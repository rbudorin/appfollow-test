...
* Корректность миграции данных профиля из в нешней системы на сайт
...
* Последовательная авторизация через разные внешние ресурсы, в профилях которых один и тот «Email»
